"""Generic, array-based statistics shared by both Talent-vs-Luck implementations."""
...
def summarize_population(talent: np.ndarray, capital: np.ndarray) -> dict:
    """Population-level summary: inequality, tail shape, and the paper's
    headline comparison — where the richest agent's talent ranks, and
    where the most-talented agent's wealth ranks."""
    ...
    return {
        ...
        "max_talent_agent_id": max_talent_idx,
