...
plus a live plot of the leader's capital over the run. Press `space` to
pause/resume, `escape` or close the window to quit.
...
```bash
python -m pytest simulation/tests spatial_sim/tests
```
